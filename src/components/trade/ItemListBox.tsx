...
export default function ItemListBox({ postData }: { postData: TradePostReadingData }) {
  const itemImgSrc = postData.trade_item?.item.img_url;

  return (
    <div className='cursor-pointer w-full mx-auto grid grid-cols-4 items-center border rounded-2xl p-4 gap-10 md:grid-cols-5 md:py-6'>
      <div>
